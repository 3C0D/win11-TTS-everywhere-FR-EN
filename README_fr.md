...
- **🤖 Support Multi-Langues** : Détection automatique du texte anglais et français
- **🎵 Personnalisation des Voix** : Sélectionnez différentes voix pour chaque langue
...
- **🔧 Paramètres Persistants** : Vos préférences sont sauvegardées automatiquement
...
- ✅ **Gestion d'État** : Option startMinimized ajoutée avec persistance
